...
const Cart = () => {
  ...
  const totalAmount =
    cart.totalAmount ?? cart.items.reduce((s, i) => s + (i.totalPrice || 0), 0);
    ...
    <div className="cart-page">
      ...
      {!cart || !cart.items?.length ? (
        <div className="empty-cart">
          ...
          <button
            onClick={() => navigate("/care-products")}
        ...
        <div className="cart-container">
          {cart.items.map((item) => (
            <div
              className="cart-item"
              key={item.productId || item.Id || item.HaircareProductId}
            >
              <img
              ...
              <div className="cart-details">
                ...
                <button
                  ...
                  onClick={() =>
                    removeItem(
                      item.productId || item.Id || item.HaircareProductId
                    )
                  }
                >
                  Remove
